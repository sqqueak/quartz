...
description: "Summarizing my internship project at Two Sigma (Summer 2025)"
pubDate: 2025-09-03
tags: ["compilers", "technical"]
---
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/overview.svg"
  alt=""
  caption=""
  width="35%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img1.svg"
  alt=""
  caption="Fig 1: Two computers interpreting the same data according to different protocols."
  width="80%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img2.svg"
  alt=""
  caption="Fig 2: Example struct and variant."
  width="35%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img3.svg"
  alt=""
  caption="Fig 3: Example protocol tree."
  width="100%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img4.svg"
  alt=""
  caption="Fig 4: Only one variant arm of the sender & receiver protocols match."
  width="130%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img5.svg"
  alt=""
  caption="Fig 5: Trimming the protocol using a manifest."
  width="100%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img6.svg"
  alt=""
  caption="Fig 6: An example of an unsafe upgrade."
  width="100%"
/>
...
<BlogImage
  src="/images/manifests-for-protocol-compatibility/img7.svg"
  alt=""
  caption="Fig 7: Relationships between IRs and user input."
  width="50%"
/>
